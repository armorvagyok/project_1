...
export default function PostCard({ post } : {post : Post}) {
    ...
    function ShareRender() {
        if (post.url === "" || post.url === null) {
            return <></>
        } else return <a href={post.url} className="openlink2" color="rgb(0, 184, 107)" target="_blank"><Image width={20} height={20} src="https://media.discordapp.net/attachments/761616483922608158/1178625230927822899/share.png?ex=6576d348&is=65645e48&hm=79c937be92d13a91569826903f6e87f6dd1ce78424531dc3c80595c6c1f6480d&=&format=webp"></Image></a>
    }
}